 ...
 */
?>
<!-- wp:group {"style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"7.5vw","right":"7.5vw"},"margin":{"top":"0","bottom":"0"}},"dimensions":{"minHeight":""}},"className":"header-cover","layout":{"type":"default"},"metadata":{"name":"Header Cover"}} -->
<div class="wp-block-group header-cover" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:7.5vw;padding-bottom:0;padding-left:7.5vw"><!-- wp:cover {"url":"<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/Lunds-Universitet_Mikael-Risedal-870x579-1.jpg-1920x.jpg","id":79,"dimRatio":60,"minHeight":584,"minHeightUnit":"px","customGradient":"linear-gradient(180deg,rgba(7,146,227,0) 0%,rgb(0,0,0) 100%)","contentPosition":"bottom center","align":"wide","style":{"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"top":"0","bottom":"0"}},"border":{"radius":{"topLeft":"0px","topRight":"0px","bottomLeft":"30px","bottomRight":"30px"}}},"layout":{"type":"default"},"fontSize":"large"} -->
<div class="wp-block-cover alignwide has-custom-content-position is-position-bottom-center has-large-font-size" style="border-top-left-radius:0px;border-top-right-radius:0px;border-bottom-left-radius:30px;border-bottom-right-radius:30px;margin-top:0;margin-bottom:0;padding-top:0;padding-bottom:0;min-height:584px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-60 has-background-dim wp-block-cover__gradient-background has-background-gradient" style="background:linear-gradient(180deg,rgba(7,146,227,0) 0%,rgb(0,0,0) 100%)"></span><img class="wp-block-cover__image-background wp-image-79" alt="<?php echo esc_attr_e( 'HomePageBg', 'ESN Sweden' ); ?>" src="?php echo esc_url( get_stylesheet_directory_uri() ); ?/assets/images/Lunds-Universitet_Mikael-Risedal-870x579-1.jpg-1920x.jpg" data-object-fit="cover" /><div class="wp-block-cover__inner-container"><!-- wp:heading {"textAlign":"left","level":1,"style":{"spacing":{"padding":{"top":"0","bottom":"0"},"margin":{"top":"0","bottom":"0","left":"var:preset|spacing|30","right":"var:preset|spacing|30"}}},"className":"is-style-default"} -->
<h1 class="wp-block-heading has-text-align-left is-style-default" style="margin-top:0;margin-right:var(--wp--preset--spacing--30);margin-bottom:0;margin-left:var(--wp--preset--spacing--30);padding-top:0;padding-bottom:0">Erasmus Student Network</h1>
<!-- /wp:heading -->

<!-- wp:heading {"level":1} -->
<h1 class="wp-block-heading">   Lund</h1>
<!-- /wp:heading -->
...
<!-- wp:group {"tagName":"main","style":{"spacing":{"blockGap":"0","margin":{"top":"0"},"padding":{"right":"0","left":"0"}}},"className":"entry-content","layout":{"type":"default"},"metadata":{"name":"Content"}} -->
<main class="wp-block-group entry-content" style="margin-top:0;padding-right:0;padding-left:0"><!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}}},"layout":{"type":"constrained"}} -->
...
<figure class="wp-block-image size-large is-style-rounded"><img src="?php echo esc_url( get_stylesheet_directory_uri() ); ?/assets/images/tourist-and-building.webp" alt="<?php echo esc_attr_e( 'Tourist taking photo of a building', 'ESN Sweden' ); ?>" /></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<div class="wp-block-column" style="flex-basis:50%"><!-- wp:image {"sizeSlug":"large","linkDestination":"none","className":"is-style-rounded"} -->
<figure class="wp-block-image size-large is-style-rounded"><img src="?php echo esc_url( get_stylesheet_directory_uri() ); ?/assets/images/windows.webp" alt="<?php echo esc_attr_e( 'Windows of a building in Nuremberg, Germany', 'ESN Sweden' ); ?>" /></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<!-- wp:group {"style":{"position":{"type":""},"dimensions":{"minHeight":"155px"}},"className":"header-group","layout":{"type":"default"},"metadata":{"name":"Header"}} -->
<div class="wp-block-group header-group" style="min-height:155px"><!-- wp:template-part {"slug":"header","tagName":"header","area":"header"} /--></div>
<!-- /wp:group -->
