...
ESN Lund's theme is based on the Twenty Twenty-Four theme and uses some modifications by ESN Sweden.
...
ESN Sweden is a child theme of Twenty Twenty-Four (https://wordpress.org/themes/twentytwentyfour/), (C) the WordPress team, [GPLv2 or later](http://www.gnu.org/licenses/gpl-2.0.html)
...
Kelson Sans Font
Copyright (c) 2012 by Bruno Mello. All rights reserved. 
  
-- End of Kelson Sans Font credits --
...
License URL: http://scripts.sil.org/OFL 
Source: http://dharmatype.com
-- End of Bebas Neue Font credits --
